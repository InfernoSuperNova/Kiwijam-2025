...
public partial class DebugLine : DebugMesh
{
    ...
    public DebugLine(Vector3 start, Vector3 end, Color color, float duration, float thickness, bool drawOnTop, Type type, Kiwijam2025.Debug.DebugDraw instance) : base(color, duration, drawOnTop, type, instance)
    {
        _start = start;
        _end = end;
