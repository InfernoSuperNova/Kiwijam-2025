...
public partial class DebugMesh : MeshInstance3D
{
    ...
    protected Type type;
    protected Kiwijam2025.Debug.DebugDraw Instance;
    ...
    protected DebugMesh(Color color, double duration, bool drawOnTop, Type type, Kiwijam2025.Debug.DebugDraw instance)
    {
        Color = color;
        TimeToLive = duration;
        this.type = type;
